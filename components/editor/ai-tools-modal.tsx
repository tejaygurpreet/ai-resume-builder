        ...
        {bullets.length > 0 && (
          <div className="space-y-2 rounded-lg border border-gray-200 bg-gray-50 p-3">
            ...
            {bullets.map((bullet, idx) => (
              <div
                key={idx}
                className="flex items-start gap-2 rounded-md bg-white p-2.5 text-sm text-gray-700 shadow-sm"
              >
                <span className="mt-0.5 shrink-0 text-gray-400">&bull;</span>
        ...
        {result && (
          <>
            <div className="flex flex-col items-center rounded-xl bg-gray-50 p-6">
              ...
              <span className="mt-1 text-sm text-gray-500">out of 100</span>
            </div>
        ...
        {result && (
          <div className="space-y-4 rounded-lg border border-gray-200 bg-gray-50 p-4">
            ...
            {result.tips.length > 0 && (
              <div>
                <h4 className="mb-2 text-sm font-medium text-gray-700">Tips</h4>
                <ul className="space-y-1.5">
