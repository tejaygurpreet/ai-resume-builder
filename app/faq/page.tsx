...
export const metadata: Metadata = { title: "FAQ | ResumeAI", description: "Frequently asked questions about ResumeAI's AI resume builder, pricing, exports, and data privacy." };
...
const faqItems = [
  ...
  { question: "Is ResumeAI free to use?", answer: "Yes! Our free plan gives you full access to the AI-powered resume builder, including AI writing suggestions, resume scoring, keyword matching, and cover letter generation. Free users get 10 templates and 10 exports per month with no ads. Upgrade to Pro for $7/month, $59/year, or $99 lifetime for unlimited exports and all 50+ templates." },
  { question: "What export formats are available?", answer: "ResumeAI supports four export formats: PDF (the standard format for job applications), DOCX (for editing in Microsoft Word or Google Docs), TXT (plain text for online application forms that strip formatting), and JSON (a structured data format useful for developers or programmatic workflows). All formats are available on both the Free and Pro plans." },
  { question: "How do subscriptions work?", answer: "Our Pro plan is $7/month, $59/year (save 30%), or $99 lifetime through Stripe. You can cancel at any time from your account settings — no questions asked. When you cancel, you'll continue to enjoy Pro features until the end of your current billing period. One-Time Export ($19) gives unlimited exports forever without a subscription." },
  { question: "Is my resume data private?", answer: "Absolutely. Privacy is a core value at ResumeAI. All data is encrypted both in transit (TLS) and at rest. We never sell your personal information or share it with third parties. Our AI processing is stateless — your resume content is not used to train or fine-tune any models. You can delete your account and all associated data at any time from your dashboard." },
  { question: "Can I use ResumeAI for multiple resumes?", answer: "Yes! You can create and manage as many resumes as you need from your dashboard. This is especially useful if you're applying to different types of roles and want to tailor each resume to a specific job description. Each resume can use a different template and have its own customized content." },
  { question: "Are the templates ATS-friendly?", answer: "Yes, all 20 of our templates are designed from the ground up to be compatible with Applicant Tracking Systems (ATS). We use clean formatting, standard section headings, proper document structure, and avoid elements that confuse ATS parsers like tables, columns embedded in text boxes, or unusual fonts." },
  { question: "How does the AI generate content?", answer: "ResumeAI uses OpenAI's language models to analyze your input and generate professional content. When you provide your job title, company, and a brief description, the AI produces impactful bullet points with quantified achievements. It can also write professional summaries, generate cover letters tailored to specific job descriptions, score your resume's ATS compatibility, and identify missing keywords. All AI suggestions are fully editable." },
  ...
  { question: "How do I contact support?", answer: "You can reach our support team by emailing support@resumeai.com or by using our contact page. We typically respond within 24 hours on business days. For common questions, we recommend checking this FAQ page first." },
];
    ...
    <div className="min-h-screen bg-dark">
      ...
      <section className="relative overflow-hidden py-20">
        ...
        <div className="relative mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-lg text-slate-400">Everything you need to know about ResumeAI. Can&apos;t find what you&apos;re looking for?{" "}<Link href="/contact" className="font-medium text-brand-400 underline-offset-4 hover:underline">Contact our team</Link>.</p>
        </div>
      </section>
