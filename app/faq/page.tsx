...
const faqItems = [
  ...
  { question: "Is ResumeAI free to use?", answer: "Yes! Our free plan gives you full access to the AI-powered resume builder, including AI writing suggestions, resume scoring, keyword matching, and cover letter generation. Free users have access to 2 templates and can export their resumes after watching 3 short ads. If you'd like ad-free unlimited exports and access to all 20 templates, you can upgrade to our Pro plan for just $2.99/month." },
  ...
  { question: "How do subscriptions work?", answer: "Our Pro plan is billed monthly at $2.99/month through Stripe, a secure and trusted payment processor. You can cancel at any time from your account settings — no questions asked. When you cancel, you'll continue to enjoy Pro features until the end of your current billing period. After that, your account reverts to the free plan and you keep all your resumes." },
