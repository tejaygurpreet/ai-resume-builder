...
const faqItems = [
  ...
  { question: "Is ResumeAI free to use?", answer: "Yes! Free: $0/month – 10 exports/month, 10 basic templates, 3 AI generations per resume, no ads. Pro: $7/month or $59/year (best value) or $99 lifetime – unlimited AI, all 20+ premium templates, job tailoring, cover letter, ATS score, unlimited exports. One-Time Export: $19 – unlimited exports forever, no ads, all formats." },
  ...
  { question: "How do subscriptions work?", answer: "Free: $0/month – 10 exports/month, 10 basic templates, 3 AI generations per resume, no ads. Pro: $7/month or $59/year (best value) or $99 lifetime – unlimited AI, all 20+ templates, job tailoring, cover letter, ATS score, unlimited exports. One-Time Export: $19 one-time – unlimited exports forever, no ads, all formats (no Pro AI features). Cancel Pro anytime." },
  ...
  { question: "Are the templates ATS-friendly?", answer: "Yes, all 20+ of our templates are designed for Applicant Tracking Systems (ATS). We use clean formatting, standard section headings, proper document structure, and avoid elements that confuse ATS parsers like tables, columns embedded in text boxes, or unusual fonts." },
