        ...
        <section className="px-4 py-16 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl space-y-10">
            ...
            <div>
              ...
              <p className="mt-3 text-base leading-relaxed text-gray-600">
                <strong className="text-gray-900">Your Content:</strong> You
              ...
              <p className="mt-3 text-base leading-relaxed text-gray-600">
                <strong className="text-gray-900">Our Property:</strong> The
            ...
            <div>
              ...
              <ul className="mt-4 space-y-3 text-base leading-relaxed text-gray-600">
                <li className="flex gap-3">
                  <span className="mt-1 block h-1.5 w-1.5 flex-shrink-0 rounded-full bg-blue-500" />
                  <span>
                    <strong className="text-gray-900">Free Plan</strong> — Access
                ...
                <li className="flex gap-3">
                  <span className="mt-1 block h-1.5 w-1.5 flex-shrink-0 rounded-full bg-blue-500" />
                  <span>
                    <strong className="text-gray-900">Pro Plan</strong> — Access
            ...
            <div>
              ...
              <ul className="mt-4 space-y-3 text-base leading-relaxed text-gray-600">
                <li className="flex gap-3">
                  <span className="mt-1 block h-1.5 w-1.5 flex-shrink-0 rounded-full bg-blue-500" />
                  <span>
                    <strong className="text-gray-900">PDF</strong> — Polished,
                ...
                <li className="flex gap-3">
                  <span className="mt-1 block h-1.5 w-1.5 flex-shrink-0 rounded-full bg-blue-500" />
                  <span>
                    <strong className="text-gray-900">DOCX</strong> — Editable
                ...
                <li className="flex gap-3">
                  <span className="mt-1 block h-1.5 w-1.5 flex-shrink-0 rounded-full bg-blue-500" />
                  <span>
                    <strong className="text-gray-900">TXT</strong> — Plain text
                ...
                <li className="flex gap-3">
                  <span className="mt-1 block h-1.5 w-1.5 flex-shrink-0 rounded-full bg-blue-500" />
                  <span>
                    <strong className="text-gray-900">JSON</strong> — Structured
            ...
            <div>
              ...
              <div className="mt-4 rounded-lg border border-gray-200 bg-gray-50 p-6">
                <p className="text-base font-medium text-gray-900">ResumeAI</p>
