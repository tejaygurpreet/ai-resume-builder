    ...
    <div className="min-h-screen bg-surface">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto grid max-w-5xl items-center gap-12 lg:grid-cols-2">
            ...
            <div className="relative" aria-hidden="true">
              <div className="rounded-2xl border border-slate-200/60 bg-gradient-to-br from-brand-50 to-white p-10 shadow-lg">
                <div className="space-y-6">
                  ...
                  <div className="flex gap-2">
                    <div className="h-8 rounded-full bg-brand-100 px-4" />
                    <div className="h-8 rounded-full bg-brand-100 px-6" />
                    <div className="h-8 rounded-full bg-brand-100 px-3" />
                  </div>
                  <div className="space-y-2">
                    <div className="h-2.5 w-full rounded bg-slate-200" />
                ...
                <div className="absolute -right-4 -top-4 h-24 w-24 rounded-full bg-brand-400/20 blur-2xl" />
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {aiFeatures.map(({ Icon, title, description }) => (
              <div
                key={title}
                className="group relative rounded-2xl border border-slate-200 bg-white p-8 shadow-card transition-all duration-300 hover:shadow-card-hover hover:border-brand-200"
              >
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {audiences.map(({ Icon, title, description }) => (
              <div
                key={title}
                className="rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-card transition-all duration-300 hover:shadow-card-hover"
              >
                <div className="mx-auto mb-4 inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-brand-50 text-brand-600">
      ...
      <section className="relative overflow-hidden bg-brand-600 py-24">
        ...
        <div className="relative mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <Link
            href="/templates"
            className="mt-8 inline-flex h-12 items-center justify-center gap-2 rounded-xl bg-white px-8 text-sm font-semibold text-brand-600 shadow-lg transition-all hover:bg-brand-50"
          >
            Browse Templates
